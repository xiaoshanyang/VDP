...
var sum = 0;
var fileList = [];
fileList.push('middlewares/data/upload/F2A-13913-104020_0447_01-1100901162-20161121-1.txt');
...
var categoryId = '57c44b3868a639091c5fff01';
...
fileList.forEach(function (e) {
    ...
    //var designId = strFileName[2]+'_'+strFileName[3]+'_'+strFileName[4];
    ...
    query.state = 1;
    query.endSerialNum = {};
    query.endSerialNum.$gt = 0;
    var options = { limit: 1, sort: '-_id'};
    Order.find(query, '', options, function (err, rs) {
        if(err){

        }
        if(rs.length>0){
            startSerial = rs[0].endSerialNum + 1;
            importcode();
        }
    });
    function importcode() {
